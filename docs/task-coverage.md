...
A subsequent source-evidence audit recovered the saved successful DrawTriangle-v1 source at seed 820 (205 steps) from that interrupted run. Its recovery remains unverified. The coverage table now includes this source and the later calibration reports; see [source gaps and repair priorities](source-backlog.md).
